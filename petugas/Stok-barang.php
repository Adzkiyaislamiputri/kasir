                    ...
                    <div class="table-responsive">
                        <table class="table" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <tr>
                                ...
                                <td><a type="button" href="?page=edit-barang&produk_id=<?php echo $data['produk_id']?>"
                                       class="btn btn-sm btn-primary btn-icon-split btn-sm">
                                       <span class="icon text-white-50"><i class="fas fa-edit"></i></span>
                                       <span class="text">Edit</span>
                                    </a>
                                    <a onclick="return confirm('Apakah anda yakin ingin menghapusnya')" href="?page=hapus-barang&produk_id=<?php echo $data['produk_id']?>"
